...
if(FORCE_HTTPS && location.protocol==='http:')
	...
	navigator.serviceWorker.register('/_assets/_js/RomPatcher.js/_cache_service_worker.js', {scope: '/_assets/_js/RomPatcher.js/'});
...
try{
	...
	webWorkerCreate=new Worker('/_assets/_js/RomPatcher.js/js/worker_create.js');
	...
	webWorkerCrc=new Worker('/_assets/_js/RomPatcher.js/js/worker_crc.js');
...
addEvent(window,'load',function(){
	...
	if(CAN_USE_WEB_WORKERS){
		...
		zip.workerScriptsPath='/_assets/_js/RomPatcher.js/js/zip.js/';
	}else{
		zip.useWebWorkers=false;

		var script=document.createElement('script');
		script.src='/_assets/_js/RomPatcher.js/js/zip.js/inflate.js';
		document.getElementsByTagName('head')[0].appendChild(script);
	}
	
	el('row-file-patch').title=_('compatible_formats')+' BPS';
